...
const PROJECTS = [
  ...
  },
  {
    ...
    link: "https://chatapp-6qu6.vercel.app/",
  },
  {
    n: "04",
...
const Work = () => {
  ...
  return (
    <section
      id="work"
      style={{ padding: "140px 40px", background: "var(--cream)" }}
    >
      <style>{`
        .work-section {
          padding: 140px 40px;
      ...
      <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
        ...
        >
          ...
          >
            Every project is a case study in clean architecture, performance,
            and visual craft.
          </p>
        </div>
                ...
                >
                  ...
                  <span
                    ...
                    style={{
                      fontWeight: 700,
                      letterSpacing: ".1em",
                      color: isHovered ? project.col : "var(--muted)",
                      transition: "color .3s",
                    }}
                  >
                    {project.n}
                    ...
                    >
                      <div
                        style={{
                          ...
                          flexShrink: 0,
                          transition:
                            "background .3s, transform .4s cubic-bezier(.34,1.56,.64,1)",
                          transform: isHovered
                  ...
                  >
                    <svg
                      ...
                      viewBox="0 0 24 24"
                      fill="none"
                      stroke={isHovered ? "var(--ink)" : "var(--muted)"}
                      strokeWidth="2.5"
                      strokeLinecap="round"
                    >
