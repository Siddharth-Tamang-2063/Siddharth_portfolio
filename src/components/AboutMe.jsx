    ...
    <>
      <style>{`
        ...
        @media (max-width: 480px) {
          ...
          .skill-card-tags { gap: 5px !important; }
          .skill-card-tag  { font-size: 8px !important; padding: 4px 8px !important; }
          .skill-card-watermark { font-size: 80px !important; }
        }

        .skill-card { transition: box-shadow 0.3s ease; }
        .skill-card:hover { box-shadow: 0 28px 72px rgba(0,0,0,0.11); }
      `}</style>
